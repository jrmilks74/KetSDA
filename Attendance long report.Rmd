...
```{r import data}
Weekly_total <- read.csv("~/Desktop/KetSDA/Weekly total-Table 1.csv")
...
Monthly_average <- read.csv("~/Desktop/KetSDA/Monthly average-KetSDA.csv")
...
Engaging with our expanded online audience is imperative for continue church growth. Here are a few of my own suggestions to consider:

        * Increase Zoom access in Sabbath Schools 
                + N1, N3, N4, and Upper Room Sabbath Schools for adults 
